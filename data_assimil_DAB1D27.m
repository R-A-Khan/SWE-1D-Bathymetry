...
line_min    = false;        % Find optimal step
...
%%
str = sprintf('Bath/Case DAB1D27/DAB1D27_case_%d',case_num);
% Saving Data
% save(str, 'ntrial', 'n_obs', 'ran7_x0','x0_min', 'dmu', 'line_min','smooth_grad', 'iter_max', ...
