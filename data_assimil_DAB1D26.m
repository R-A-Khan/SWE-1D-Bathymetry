...
amp_ic    = [0.0001:0.0001:0.002]; % amplitude of initial condition
...
disp('Nonlinear SWE');
    ...
    bathy_np_type, amp_ic(k), k_ic, k_bathy, phi_bathy, conj_grad_type, iter_chunk, a, c, cfl, noisy_obs, print_iter);
    end
    disp(' ');
    
%%
str = sprintf('Bath/Case DAB1D26/DAB1D26_case_%d',case_num);
% Saving Data
